...
public class DetallePago implements Serializable {
    ...
    public DetallePago userID(String userID) {
    ...
    public DetallePago company(String company) {
    ...
    public DetallePago sequenceBank(Integer sequenceBank) {
    ...
    public DetallePago salarioBruto(BigDecimal salarioBruto) {
    ...
    public DetallePago adicionales(BigDecimal adicionales) {
    ...
    public DetallePago deducciones(BigDecimal deducciones) {
    ...
    public DetallePago otrasdeducciones(BigDecimal otrasdeducciones) {
    ...
    public DetallePago socialSecurity(BigDecimal socialSecurity) {
    ...
    public DetallePago renta(BigDecimal renta) {
        this.setRenta(renta);
        return this;
    }
    ...
    public DetallePago pagoNeto(BigDecimal pagoNeto) {
    ...
    public DetallePago adicionalesnodeducibles(BigDecimal adicionalesnodeducibles) {
    ...
    public DetallePago type(String type) {
        this.setType(type);
        return this;
    }
    ...
    public DetallePago status(EstadoPago status) {
    ...
    public DetallePago processID(String processID) {
    ...
    public DetallePago planilla(Planilla planilla) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof DetallePago)) {
            return false;
        }
        return id != null && id.equals(((DetallePago) o).id);
    }
