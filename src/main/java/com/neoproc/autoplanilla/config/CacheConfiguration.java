package com.neoproc.autoplanilla.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.neoproc.autoplanilla.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.neoproc.autoplanilla.repository.UserRepository.USERS_BY_EMAIL_CACHE);
