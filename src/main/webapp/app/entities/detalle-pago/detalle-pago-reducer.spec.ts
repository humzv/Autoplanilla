...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DETALLEPAGO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DETALLEPAGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DETALLEPAGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DETALLEPAGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DETALLEPAGO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DETALLEPAGO actions', async () => {
      const expectedActions = [
        {
