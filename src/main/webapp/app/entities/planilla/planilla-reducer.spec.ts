...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './planilla.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLANILLA_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLANILLA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLANILLA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLANILLA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLANILLA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLANILLA actions', async () => {
      const expectedActions = [
        {
